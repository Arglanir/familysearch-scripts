...
function familyTreeRecursive({
    ...
    fetch("/service/tree/tree-data/v8/person/" + from + "/card?locale=fr&includeTempleRollupStatus=true&stillbornDataProblemEx=true&matchUsesTreeHintEx=true"
    )
    .then(response => {
        return response.json();
    })
    .then(function (infolocal) {
        fetch("/service/tree/tree-data/family-members/person/" + from).then(response => {
                return response.json();
...
// example of infolocal, comming from https://www.familysearch.org/service/tree/tree-data/person/L62N-WQ4/card?&stillbornDataProblemEx=true&matchUsesTreeHintEx=true
/*{
    "birthlikeConclusion": {
        "contributor": {
    ...
    "deathlikeConclusion": {
        "contributor": {
            ...
            "id": "MMMM-MMN",
            "name": null,
            "timestamp": "2019-06-06T21:16:10+00:00"
        },
        "details": {
            "detailsType": "EventDetails",
            "date": {
    ...
    "portraitUrl": "https://tree-portraits-pgp.familysearchcdn.org/vpvy2/thumb200s.jpg",
    "readOnly": false,
    "skeleton": false,
    "sourceCount": 4,
    "spaceId": "MMMM-MMM"
...
// example of fullinfo, comming from https://www.familysearch.org/service/tree/tree-data/family-members/person/L62N-WQ4
/*{
    "status": "OK",
    "statusText": null,
    "data": {
